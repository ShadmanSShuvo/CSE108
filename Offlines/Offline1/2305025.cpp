...
public:
    ...
    void print()
    {
        ...
        cout << "Max: "; //<< getmax().print() << endl;
        getmax().print();
        cout << "Min: "; //<< getmin().print() << endl;
        getmin().print();
        sum = add(0, length-1);
        prod = mul(0, length-1);
        cout << "Summation: "; // << sum.print() << endl;
        sum.print();
        cout << "Multiplication: "; // << prod.print() << endl;
        prod.print();
        // cout << "Multiplication: " << mul.print() << endl;
